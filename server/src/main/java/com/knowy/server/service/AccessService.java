...
public class AccessService {
	 ...
	 */
	public AccessService(JwtService jwtService, EmailClientService emailClientService, PrivateUserRepository privateUserRepository, PublicUserRepository publicUserRepository, ProfileImageRepository profileImageRepository, PasswordEncoder passwordEncoder, PasswordChecker passwordChecker) {
